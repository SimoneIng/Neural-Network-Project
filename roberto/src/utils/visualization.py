...
def plot_confusion_matrix(cm, title='Confusion Matrix', model_type=None, save_dir='./images'):
...
def plot_training_history(history, title='Training History', model_type=None, save_dir='./images'):
...
def plot_random_search_results(results, title, model_type=None, save_dir='./images'):
...
def plot_epoch_comparison(results, model_type, save_dir='./images'):
...
def plot_hyperparameter_impact(results, param_name, model_type, save_dir='./images'):
    ...
    avg_accuracies = [sum(param_groups[val])/len(param_groups[val]) if param_groups[val] else 0 for val in param_values]
